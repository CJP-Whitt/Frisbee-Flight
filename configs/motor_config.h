/*
    ...
    Created:	11/29/2022
    Author:	    CWhitt
    Description: This file holds the motor config params for the main file of this project. Any motor
        presets can be changed here to work with other hardware.
